                ...
                .join('circle')
                    ...
                    .on('mouseover',(e,d) => {
                        ...
                        tooldiv.style('visibility','visible')
                            .text(`Title: ${d['Title']}  ${labelX}: ${d[cat.current]} ${labelY}: ${d[num.current]}`)
                    })
                    .on('mousemove', (e,d)=>{
            ...
            <div id = 'chartArea' style={chartStyle}>
                <svg ref = {svgRef}>
                    ...
                    <svg id="mySvg" width="80" height="80">
                        <defs id="mdef">
                            <pattern id="image" x="0" y="0" height="15" width="15">
                                <image x="0" y="0" width="15" height="15" href='pokeball.svg'></image>
                            </pattern>
                            <pattern id="image2" x="0" y="0" height="15" width="15">
                                <image x="0" y="0" width="15" height="15" href='change.svg'></image>
                            </pattern>
                            <pattern id="image3" x="0" y="0" height='15' width="15">
                                <image x="0" y="0" width="15" height="15" href='open.svg'></image>
                            </pattern>
                        </defs>
                    </svg>
                </svg>
